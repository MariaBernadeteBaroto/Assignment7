...
if len(password) <= 15:
    print('password not valid! must have at least 16 characters.')
...
if capital == 0:
    print('password not valid! must have at least one capital.')
...
if number == 0:
    print('password not valid! must have at least one number.')
...
if special == 0:
    print('password not valid! must have at least one special character.')
